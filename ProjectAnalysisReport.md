...
4. **CWE-78**: Upozorava nas da je pronadena potencijalno opasna upotreba funkcije system() u izvornom kodu. Funkcija system() se koristi za izvršavanje sistemskih komandi i može biti opasna ako se koristi sa nevalidnim ili nekontrolisanim korisničkim unosima, jer može omogućiti ”OS Command Injection” napade. Umesto korišćenja funkcije system() za izvršavanje sistema komandi, preporučljivo je koristiti bibliotečke funkcije koje su dizajnirane da budu bezbednije i omogućavaju kontrolisanu manipulaciju sa sistemskim resursima. Primer toga bi bila upotreba funkcija sistema datoteka kao što su open(), read(), write(), close().
